...
--automatically log into the correct database (psql specific)
\c gamification_obd 
...
-- 	-- Cross join member_id with (quest_ids and statuses)
	...
	-- notify about newly initialized player
	PERFORM PUBLIC.NOTIFY('game:' || game_id || ',user:' || member_id || ',action:' || 'initToGame');
...
-- function to output notifications which can be read externally
